...
class ItemTest {
    ...
    @Test
    @DisplayName("Should apply correct taxes to non imported, exempt items")
    ...
    public void tesImportedNonExempt () {
        ...
        assertEquals(0.1, item.getRegularTaxRateApplied());
        assertEquals(0.05, item.getImportedTaxRateApplied());
    }
